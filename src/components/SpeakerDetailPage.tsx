          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            {speaker.website && (
              <a
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-white/15 hover:bg-white/25 text-xs font-bold text-white border border-white/30 transition active:scale-95"
              >
