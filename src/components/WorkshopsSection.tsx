...
export const WorkshopsSection: React.FC<WorkshopsSectionProps> = ({ onSelectWorkshop }) => {
  const getWorkshopImage = (id: string) => {
    switch (id) {
      case "jardineria":
        return FESTIVAL_IMAGES.gardening;
      case "percussio":
        return FESTIVAL_IMAGES.percussion;
      case "teatre-expressio":
        return FESTIVAL_IMAGES.theater;
      case "espai-nadons":
        return FESTIVAL_IMAGES.nadons;
      default:
        return FESTIVAL_IMAGES.workshop;
    }
  };

  const title = "Tallers";
  const subtitle =
    "Natura, Art i Poble. De 10:00 a 12:00 del matí (Acollida a les 9:30 a la Plaça de la Vila)";
  ...
  return (
    <section
      id="tallers"
      className="py-20 sm:py-28 bg-transparent border-b border-secondary/25 relative"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-3xl mb-12 space-y-3">
          ...
          <div className="text-base sm:text-lg text-festmuted leading-relaxed">
            <span className="block text-lg sm:text-xl text-secondary uppercase">
              Natura, Art i Poble.
            </span>
              ...
              >
                ...
                <div className="sm:w-3/5 p-6 sm:p-7 flex flex-col justify-between space-y-4">
                  <div className="space-y-3">
                    {/* Tags row */}
                    <div className="text-xs text-secondary font-bold">{workshop.instructor}</div>
