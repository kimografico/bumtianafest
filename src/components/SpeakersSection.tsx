...
export const SpeakersSection: React.FC<SpeakersSectionProps> = ({
  ...
  const title = 'Xerrades';
  const subtitle = 'Espais de reflexió, benestar i acompanyament en les diferents etapes del creixement.';
  const viewDetails = 'Veure detalls de la xerrada';
